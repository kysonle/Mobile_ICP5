...
public class EmployerActivity extends AppCompatActivity {
    ...
    private void deleteInDB(){
        ...
        database.delete(SampleDBContract.Employer.TABLE_NAME, SampleDBContract.Employer.COLUMN_NAME + "='" + companyname + "'",null);
        Toast.makeText(this, "Employer " + companyname + " " + "have been deleted from the database system", Toast.LENGTH_LONG).show();
        finish();
